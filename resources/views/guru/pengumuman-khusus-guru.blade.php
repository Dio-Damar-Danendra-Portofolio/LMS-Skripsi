...
@section('title', 'Pengumuman untuk Guru - EduSMA')
@section('content')
<div class="diodamar">
    <table style="border: none; margin-bottom: 20px;">
        <tr>
            <th>
                <h1>Daftar Pengumuman khusus Guru</h1>
            </th>
            <th colspan = 10>
...
<div class="grid-container">
    ...
    <div class="grid-column">
        ...
        <ul style = "list-style-type: none;">
            <li><button type="button" class="btn btn-light mb-5" style="font-size: 35pt; border: 1px solid black;"><a href="{{ route('guru.isi-pengumuman-guru') }}" style = "text-decoration: none; color: black;"><?php echo $DataPengumuman['JudulPengumuman'] ?? 'Tiada' ?></a></button></li>
            <li><button type="button" class="btn btn-light mb-5" style="font-size: 35pt; border: 1px solid black;"><a href="{{ route('guru.isi-pengumuman-guru') }}" style = "text-decoration: none; color: black;"><?php echo $DataPengumuman['JudulPengumuman'] ?? 'Tiada' ?></a></button></li>
            <li><button type="button" class="btn btn-light mb-5" style="font-size: 35pt; border: 1px solid black;"><a href="{{ route('guru.isi-pengumuman-guru') }}" style = "text-decoration: none; color: black;"><?php echo $DataPengumuman['JudulPengumuman'] ?? 'Tiada' ?></a></button></li>
            <li><button type="button" class="btn btn-light mb-5" style="font-size: 35pt; border: 1px solid black;"><a href="{{ route('guru.isi-pengumuman-guru') }}" style = "text-decoration: none; color: black;"><?php echo $DataPengumuman['JudulPengumuman'] ?? 'Tiada' ?></a></button></li>
            <li><button type="button" class="btn btn-light mb-5" style="font-size: 35pt; border: 1px solid black;"><a href="{{ route('guru.isi-pengumuman-guru') }}" style = "text-decoration: none; color: black;"><?php echo $DataPengumuman['JudulPengumuman'] ?? 'Tiada' ?></a></button></li>
