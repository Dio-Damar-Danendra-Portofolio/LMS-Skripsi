...
@section('title', 'Kelas {KelasSiswa} - EduSMA')
@section('content')
<div class="diodamar">
    <div class="grid-container">
        ...
        <div class="grid-column">
            <img src="https://www.colorhexa.com/" length="200" width="10">
        </div>
        <div class="grid-column">
            <div style="translate: 15px 0px;">
                <a href="{{ route('siswa.beranda-siswa') }}">
...
<div class="d-flex align-items-center mr-4">
        <span>Tampilkan: </span> 
        <form action="{{ __('kelas-siswa') }}" method="get">
