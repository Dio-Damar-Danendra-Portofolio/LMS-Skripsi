<div class="c-page-region">
    ...
    <div class="list-forum-wrapper pt-1">
        ...
        <table style="border: none;">
            <tr>
                <th><a href="http://127.0.0.1:8000/NamaMataPelajaran/materi/forum-guru/Thread-Baru" role="button" class="btn btn-primary">Buat Thread Baru!</a></th>
                <th></th>
                <th>
                    <div class="C--pagination type--1">
                        <span><?php echo "80 hasil"; ?></span>
                    </div>
                </th>
                <th>
        ...
        <div class="diodamar">
            <a href="{{ __('http://127.0.0.1:8000/NamaMataPelajaran/materi/forum-guru/thread/judulthread/isi') }}" style="all: unset;">
                ...
                <div class="C--card type--1 mb-0 py-2 br-5 thread-item-card no-border border-bottom">
                                ...
                                <div class="d-flex flex-row align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="d-flex flex-row">
                                            <span class="author-name">{NamaGuru}</span>
                                        </div>
                    ...
                    <div class="thread-author-name mt-3">
                        ...
                        <div class="ellipsis-one-line" style="font-size:18px;">
                            <span class="false thread-title">{JudulThread}</span>
                        </div>
                    </div>
                    </div>
