...
@section('title', 'Forum Guru - EduSMA')
@section('content')
<div class = "diodamar">
...
<!-- if(forum ada) -->
@include('mata_pelajaran.isi-forum-untuk-guru')
<!-- else (Forum tidak ada) -->
@include('mata_pelajaran.forum-kosong-untuk-guru')
@endsection