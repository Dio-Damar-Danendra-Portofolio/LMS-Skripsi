<div class="c-page-region">
    ...
    <div class="list-forum-wrapper pt-1">
        ...
        <table style="border: none;">
            <tr>
                <th><a href="{{ route('mata-pelajaran.thread-baru-guru') }}" role="button" class="btn btn-primary">Buat Thread Baru!</a></th>
                <th></th>
                <th>
        ...
        <div class="diodamar">
            <a href="{{ route('mata-pelajaran.isi-thread-guru') }}" style="all: unset;">
