...
@section('title', 'Forum Siswa mapel {{MataPelajaran}} - EduSMA')
@section('content')
<div class = "diodamar">
<table style = "border: none;">
<tr>
    <th>
        <h1><?php echo $Forum['JudulForum'] ?? 'Tidak Ada Judul Forum' ?></h1>
        <p><?php echo $Forum['DeskripsiForum'] ?? 'Tidak Ada Deskripsi Forum' ?></p>
    </th>
    <th colspan = 10>
    ...
    <div class = "grid-column">
        <ul class = "nav nav-item">
            <li style="margin-right: 40px;">
                <button type="button" class="btn btn-danger"><?php echo $Materi['JudulMateri'] ?? 'Materi Tidak Tersedia' ?></button>
            </li>
            <li style="margin-right: 40px;">
                <button type="button" class="btn btn-danger"><?php echo $Materi['JudulMateri'] ?? 'Materi Tidak Tersedia' ?></button>
            </li>
...
<!-- if(forum ada) -->
@include('mata_pelajaran.isi-forum-untuk-siswa')
<!-- else (Forum tidak ada) -->
<!-- @include('mata_pelajaran.forum-kosong-untuk-siswa') -->
@endsection