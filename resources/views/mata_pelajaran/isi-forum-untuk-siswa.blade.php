<div class="c-page-region">
    ...
    <div class="list-forum-wrapper pt-1">
        ...
        <table style="border: none;">
            <tr>
                <th><a href="{{ route('mata_pelajaran.thread-baru-siswa') }}" role="button" class="btn btn-primary">Buat Thread Baru!</a></th>
                <th></th>
                <th>
        ...
        <div class="diodamar">
            <a href="{{ route('mata_pelajaran.isi-thread-siswa') }}" style="all: unset;">
