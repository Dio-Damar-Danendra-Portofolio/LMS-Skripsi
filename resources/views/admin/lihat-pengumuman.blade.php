...
@section('title', 'Pratinjau (Preview) dari Pengumuman yang berjudul {{ $dataPengumuman->JudulPengumuman }}')
@section('content')
<div class="diodamar">
    <table style="border: none;">
        <tr>
            <th>
                <h1>{{ $dataPengumuman->JudulPengumuman ?? 'Tidak Ada Judul' }}</h1>
                {{ $dataPengumuman->created_at }}
            </th>
            <th colspan = 10>
...
<div class="grid-container">
    <div class="grid-column">
        ...
        <tr>
            <td colspan = 2>
                <p>{{ $dataPengumuman -> IsiPengumuman ?? "Maaf, saat ini belum ada berita baru dari sekolah..." }}</p>
            </td>
        </tr>
        <tr>
