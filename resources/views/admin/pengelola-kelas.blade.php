...
@section('title', 'Pengelola Kelas - EduSMA')
@section('content')
<div class="diodamar">
    <table style="border: none;">
        <tr>
            ...
            <td colspan=20>
                <img src="https://www.colorhexa.com/ffffff.png" length = "20" width = "3" />
            </td>
            <td></td>
            <td></td>
            <td></td>
...
<div class="grid-container">
    <table style="border: none;">
        <tr>
            <td rowspan=10>
                <a href="{{ route('admin.tambah-kelas') }}" style="text-decoration: none; color: black; font-size: 23pt;">
        ...
        <tr>
                <td>
                    <a href="{{ route('admin.lihat-kelas') }}">
                        <button type="button" class="btn btn-light mb-5" style="font-size: 35pt; border: 1px solid black;">{{ $dataKelas->NamaKelas }}</button>
                    </a>
                    <a href="{{ route('admin.sunting-kelas') }}">
...
<div class="grid-column">
    <div class="d-flex align-items-center mr-4">
        <span>Tampilkan: </span> 
        <form action="{{ route('admin.pengelola-kelas') }}" method="get">
            <div class="C--combobox type--1 mb-0 dropdown ml-2">
                <select name="JumlahKelas">
