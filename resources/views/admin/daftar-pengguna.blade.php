...
<div class="diodamar">
    <table style="border: none;">
        <tr>
            <td>
                <h1>Obrolan Admin - Daftar Pengguna</h1>
            </td>
            <td colspan=10>
            ...
            <td></td>
            <td>
                <a href="{{ route('admin.obrolan-admin') }}">
...
<div class="grid-container">
    <div class="grid-column">
        <a href="{{ route('admin.kolom-obrolan-admin') }}">
            <button type="button" class="btn btn-light">
                <img src="uploads/FotoProfilSiswa/{Berkas}')">
            </button>
        </a>
    </div>
    <div class="grid-column">
        <a href="{{ route('admin.kolom-obrolan-admin') }}">
            <button type="button" class="btn btn-light">
                <img src="uploads/FotoProfilGuru/{Berkas}')">
            </button>
        </a>
    </div>
    <div class="grid-column">
        <a href="{{ route('admin.kolom-obrolan-admin') }}">
            <button type="button" class="btn btn-light">
                <img src="uploads/FotoProfilAdmin/{Berkas}')">
            </button>
        </a>
    </div>
</div>
