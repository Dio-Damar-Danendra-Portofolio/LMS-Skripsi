...
@section('title', 'Jadwal  untuk {PeruntukanKelas}- EduSMA')
@section('content')
<div class="diodamar">
    <table style="border:none;">
        <tr>
            <td>
                <h1>Jadwal untuk {PeruntukanKelas} - Sesi {MataPelajaran}</h1>
            </td>
            <td colspan=10>
...
<br>
<form action="{{ route('admin.pengelola-jadwal') }}" method="post">
@csrf
<div class="diodamar">
    ...
    <table style="border:none;">
        <tr>
            ...
            <td>
                <a href="{{ route('admin.pengelola-jadwal-kelas') }}">
                    <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjbG5kZxZ2y4wxgE4JJFjEkcZcCNcBZC4PGFBJqkRFwQOih8Nknq-3e0ePl0tn8qR2tGkUpISpKm6LCktzqJcQYWQgSLPQQYe44mbtPMe_pJ6zlexrtItAPf0OoibbphhO7gdKxN2uNsJmDX4pS2SKFacCgwa-hO813iN4ij4D7tj_QFRWdASp1708yYdE/s512/left-arrow_44686.png" length="15%" width="15%">
                </a>
            </td>
        </tr>
    </table>
